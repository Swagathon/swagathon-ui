    ...
    <div className="flex min-h-screen w-full flex-col">
      <header className="sticky top-0 flex h-16 items-center gap-4 border-b bg-white px-4 md:px-6 dark:bg-gray-950">
        <nav className="hidden flex-col gap-6 text-lg font-medium md:flex md:flex-row md:items-center md:gap-5 md:text-sm lg:gap-6">
          ...
          <Link href="#" className="text-gray-950 transition-colors hover:text-gray-950 dark:text-gray-50 dark:hover:text-gray-50" prefetch={false}>
            Dashboard
          </Link>
          <Link href="#" className="text-gray-500 transition-colors hover:text-gray-950 dark:text-gray-400 dark:hover:text-gray-50" prefetch={false}>
            Orders
          </Link>
          <Link href="#" className="text-gray-500 transition-colors hover:text-gray-950 dark:text-gray-400 dark:hover:text-gray-50" prefetch={false}>
            Products
        ...
        <Sheet>
          ...
          <SheetContent side="left">
            <nav className="grid gap-6 text-lg font-medium">
              ...
              <Link href="#" className="hover:text-gray-950 dark:hover:text-gray-50" prefetch={false}>
                Dashboard
              </Link>
              <Link href="#" className="text-gray-500 hover:text-gray-950 dark:text-gray-400 dark:hover:text-gray-50" prefetch={false}>
                Orders
              </Link>
              <Link href="#" className="text-gray-500 hover:text-gray-950 dark:text-gray-400 dark:hover:text-gray-50" prefetch={false}>
                Products
                ...
                <TableBody>
                  <TableRow>
                    <TableCell>
                      ...
                      <div className="hidden text-sm text-gray-500 md:inline dark:text-gray-400">liam@example.com</div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      ...
                      <div className="hidden text-sm text-gray-500 md:inline dark:text-gray-400">olivia@example.com</div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      ...
                      <div className="hidden text-sm text-gray-500 md:inline dark:text-gray-400">noah@example.com</div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      ...
                      <div className="hidden text-sm text-gray-500 md:inline dark:text-gray-400">emma@example.com</div>
                    </TableCell>
                    <TableCell className="hidden xl:table-column">Sale</TableCell>
                    <TableCell className="hidden xl:table-column">
                      <Badge className="text-xs" variant="outline">
            ...
            <CardContent className="grid gap-8">
              <div className="flex items-center gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">olivia.martin@email.com</p>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">isabella.nguyen@email.com</p>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">will@email.com</p>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">sofia.davis@email.com</p>
                </div>
                <div className="ml-auto font-medium">+$39.00</div>
              </div>
            </CardContent>
